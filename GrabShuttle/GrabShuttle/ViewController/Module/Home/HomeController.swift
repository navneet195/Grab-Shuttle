...
class HomeController: UIViewController {
    ...
    private let actionButton: UIButton = {
        ...
        button.setImage(UIImage(named: Constants.Pref.menuImg)?.withRenderingMode(.alwaysOriginal), for: .normal)
...
extension HomeController
{
    // MARK: - Lifecycle
       ...
       fileprivate func configureActionButton(state: HomeActionButtonState) {
           switch state {
           case .dismissAction:
               self.actionButton.setImage(UIImage(named: Constants.Pref.backArrowImg)?.withRenderingMode(.alwaysOriginal), for: .normal)
               self.actionButtonState = .dismissAction
           case .sideMenu:
               self.actionButton.setImage(UIImage(named: Constants.Pref.menuImg)?.withRenderingMode(.alwaysOriginal), for: .normal)
...
extension HomeController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        view.image = UIImage(named: Constants.Pref.carImg)
        return view
    }
    ...
    func mapView(_ mapView: MKMapView, rendererFor overlay: MKOverlay) -> MKOverlayRenderer {
        ...
        lineRenderer.strokeColor = Constants.Color.primaryColor
