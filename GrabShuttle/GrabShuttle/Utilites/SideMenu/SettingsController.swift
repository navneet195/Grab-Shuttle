...
class SettingsController: UITableViewController {
    ...
    func configureTableView() {
        tableView.backgroundColor = Constants.Color.whiteColor
    ...
    func configureNavigationBar() {
        ...
        navigationController?.navigationBar.tintColor = Constants.Color.whiteColor
        navigationItem.title = "Settings"
        
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: Constants.Pref.exitImg)?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleDismissal))
    }
...
extension SettingsController {
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        titleLabel.textColor = Constants.Color.whiteColor
